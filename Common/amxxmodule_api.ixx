...
// amxx module info
export struct amxx_module_info_t
{
	const char *name;
	const char *author;
	const char *version;
...
export using AMX_NATIVE = cell(*)(struct AMX *amx, cell *params);
export using AMX_CALLBACK = int (*)(struct AMX *amx, cell index, cell *result, cell *params);
export using AMX_DEBUG = int (*)(struct AMX *amx);
...
export enum EMsgBlock : std::int32_t
{
	MSGBLOCK_SET = 0,
	MSGBLOCK_GET = 1,
};

export enum EBlockMode : std::int32_t
{
	BLOCK_NOT = 0,
	BLOCK_ONCE = 1,
	BLOCK_SET = 2,
...
export using PFN_MESSAGE_BLOCK				= void			(*)(EMsgBlock /* mode */, int /* message */, int * /* opt */);
